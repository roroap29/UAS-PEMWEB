...
<body>
    <div class="container">
        ...
        <!-- mengarahkan ke halaman berikutnya, dan mengambil data yang sudah diisikan sebelumnya -->
        <form action="proses/edit_produk.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1"
                            placeholder="Masukkan Nama Produk" disabled value="<?= $data['kode_produk']; ?>">
            ...
            <hr>
            <!-- menampilkan bom produk yang ada -->
            ...
            <div class="row">
                ...
                <!-- membuat form untuk diinputkan bom produk -->
                <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="material[]" class="form-control"
                                    placeholder="Masukkan Kode Material" value="<?= $row3['kode_bk']; ?>" required>
                            </div>
                        </div>
            ...
            <!-- membuat button edit dan cancel  -->
            <div class="row">
                <div class="col-md-6">
