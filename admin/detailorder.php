...
<body>
    <div class="container">
        ...
        <br>
        <!-- membuat tulisan informasi bergerak -->
        ...
        <!-- jika melakukan klik reload, maka akan memuaat ulang halaman -->
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <!-- menampilkan data pesanan yang telah diterima -->
                <?php 
                ...
                <tr>
                    <!-- membuat status untuk menunjukkan status pesanan -->
                    <td><?= $no; ?></td>
                    <td><?= $row['invoice']; ?></td>
                    ...
                    <td>2020/26-01</td>
                    <td>
                        <!-- membuat button untuk mengubah status pesanan -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- membuat tabel untuk ditampilkan di dalam detail pesanan yang berisikan data customer-->
                        <table class="table table-striped">
                            <tr>
                                <td>Invoice</td>
                        ...
                        <hr>
                        <h4>List Order</h4>
                        <!-- membuat tabel untuk ditampilkan di dalam detail pesanan yang berisikan data produk yang dipesan -->
                        <table class="table table-striped">
                            <tr>
                                <th>No</th>
                                <th>Kode Produk</th>
                    ...
                    <div class="modal-footer">
                        <!-- membuat button close untuk menutup detail pesanan -->
...
if($cek_sor > 0){
	?>
        ...
        <br>
        <div class="row">
            <!-- menampilkan material yang dibutuhkan namun persediaan habis -->
