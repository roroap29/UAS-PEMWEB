...
<body>
    <div class="container">
        ...
        <!-- membuat fform inputan material -->
        <form action="proses/tambah_inv.php" method="POST">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" id="exampleInputEmail1" name="kd_material"
                            value="<?php echo $format; ?>">
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="exampleInputEmail1" name="stok"
                            placeholder="contoh 2 atau 0.4" min="1">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <!-- membbuat button tambah dan cancel -->
